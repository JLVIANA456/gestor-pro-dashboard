...
export function BrandingProvider({ children }: { children: React.ReactNode }) {
    ...
    const [logoUrl, setLogoUrl] = useState<string | null>('/logo_20anos.png');
    ...
    useEffect(() => {
        const loadBranding = async () => {
            try {
                ...
                setLogoUrl(branding.logoUrl || '/logo_20anos.png');
