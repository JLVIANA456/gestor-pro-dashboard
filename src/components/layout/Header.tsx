...
import { LayoutDashboard, Users, FileText, Palette, Mail, Building2, Menu, X, Send, DollarSign, TrendingUp, Banknote, MoreHorizontal, TableProperties } from 'lucide-react';
