      ...
      <div className="px-8 mb-8 flex items-end justify-between">
        <div>
          ...
          >
            ...
            <span className="text-[10px] font-medium text-primary uppercase tracking-[0.4em]">Business Intel</span>
          </motion.div>
          <h2 className="text-4xl font-light text-foreground tracking-tight">Overview de Clientes</h2>
