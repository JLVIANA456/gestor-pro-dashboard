...
export function ProfitWithdrawalReportDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={handleClose}>
            <DialogContent className="max-w-lg bg-card border-border rounded-3xl p-8">
                <DialogHeader>
                    ...
                    {reportType === 'company' && (
                        <div className="space-y-2">
                            ...
                            <Popover open={comboOpen} onOpenChange={setComboOpen}>
                                ...
                                <PopoverContent className="w-[440px] p-0 bg-card border-border rounded-2xl shadow-elevated" align="start" sideOffset={4}>
