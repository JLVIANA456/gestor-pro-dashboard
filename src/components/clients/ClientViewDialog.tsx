          ...
          <div className="p-8 md:p-10 space-y-12">
            ...
            <section className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <InfoCard 
                  label="Data Abertura CNPJ" 
                  value={client.dataAberturaCnpj ? new Date(client.dataAberturaCnpj).toLocaleDateString('pt-BR') : undefined} 
                  icon={Calendar} 
                />

                <InfoCard label="Tipo de Atividade" value={client.tipoAtividade} icon={Globe} className="capitalize" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <section className="space-y-6">
                <SectionHeader title="Gestão & Responsáveis" icon={Users} colorClass="text-amber-500 bg-amber-500/10" />
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="h-px bg-border/20 col-span-full my-2" />
                  
                  <InfoCard label="Status BPO" value={client.statusBpo} className="sm:col-span-1 capitalize" />
                  <InfoCard label="Origem Contábil" value={client.origemContabil} className="sm:col-span-1 capitalize" />
                  <InfoCard label="Pró-labore" value={client.proLabore} className="sm:col-span-1" />
                  <div className="group flex flex-col gap-1.5 sm:col-span-1">
                    <label className="text-[10px] font-bold text-muted-foreground/60 uppercase tracking-widest px-1">Possui Funcionários</label>
                    <div className={cn(
                      "flex items-center justify-center min-h-[2.75rem] rounded-2xl border text-xs font-bold",
                      client.hasEmployees ? "bg-emerald-500/10 text-emerald-600 border-emerald-500/20" : "bg-muted/30 text-muted-foreground border-transparent"
                    )}>
