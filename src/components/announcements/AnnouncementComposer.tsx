...
export function AnnouncementComposer({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-[95vw] w-full max-w-7xl bg-card border-none rounded-[2.5rem] p-0 overflow-hidden shadow-elevated animate-in fade-in zoom-in duration-300 flex flex-col max-h-[96vh]">
                {/* Header Premium */}
                ...
                <div className="p-8 space-y-7 flex-1 overflow-y-auto custom-scrollbar">
                ...
                <div className="p-8 bg-card border-t border-border/40 flex flex-col sm:flex-row items-center justify-between gap-6">
                    <Button
                        type="button"
                        variant="ghost"
