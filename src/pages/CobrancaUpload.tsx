                ...
                <Card className="p-8 sm:p-12 rounded-[3.5rem] border-none shadow-2xl bg-white overflow-hidden relative">
                    ...
                    {completed ? (
                        <div className="flex flex-col items-center text-center space-y-6 py-10 animate-in zoom-in duration-500">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-slate-800">Recebemos tudo!</h2>
                                <p className="text-sm text-slate-400 mt-2 leading-relaxed">
                                    Os arquivos foram encaminhados com sucesso para os nossos analistas.<br/>
                                    <strong>Muito obrigado por manter seus arquivos em dia!</strong>
                                </p>
                            </div>
                            <Button variant="outline" className="rounded-2xl border-slate-100 h-12 px-8 font-black uppercase text-[10px] tracking-widest text-slate-400" onClick={() => window.location.reload()}>
                                Deseja enviar mais algum arquivo?
                            </Button>
                        </div>
                    ) : (
                        <div className="space-y-8">
                            ...
                            <div className="text-center space-y-3">
                                <h2 className="text-xl font-light text-slate-800 uppercase tracking-tight">
                                    ENVIE SEUS DOCUMENTOS - <span className="text-primary font-bold">{eventDetails?.month.split('-').reverse().join('/')}</span>
                                </h2>
