  ...
  return (
    <div className="space-y-6 animate-slide-in-up">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-light tracking-tight text-foreground">Departamento Fiscal</h1>
          <p className="text-xs font-normal text-muted-foreground uppercase tracking-[0.2em] mt-1">Gestão fiscal e tributária</p>
        </div>
      </div>
