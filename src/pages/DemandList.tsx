  ...
  return (
    <div className="space-y-10 pb-16 animate-in fade-in duration-700">
      ...
      <Dialog open={isDetailOpen} onOpenChange={setIsDetailOpen}>
        <DialogContent className="max-w-4xl w-full p-0 overflow-hidden rounded-[3rem] border-none bg-slate-50 dark:bg-slate-900 shadow-2xl">
          {selectedClient && (
            <div className="flex flex-col h-full max-h-[85vh] overflow-hidden">
              {/* Modal Header */}
              <div className="p-10 pb-8 bg-white dark:bg-slate-800 relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-6 relative z-10">
                      ...
                      <div className="flex-1 min-w-0">
                          <h2 className="text-2xl font-bold text-slate-800 dark:text-white truncate lg:max-w-xl">
              ...
              <ScrollArea className="flex-1 bg-slate-50 dark:bg-slate-900 overflow-y-auto">
                  <div className="p-10 pt-6 space-y-4 pb-20">
                      {modalTasks.length === 0 ? (
                                                   ...
                                                   if (confirmCreation) {
                                                      ...
                                                      toast.promise(
                                                        createGuide({
                                                          ...
                                                          delivered_at: null,
                                                          opened_at: null
                                                        }).then(newGuide => handleUpdateTaskStatus(newGuide as any)),
                                                        {
                                                          loading: 'Mapeando obrigação...',
                                                          success: 'Obrigação mapeada. Concluindo baixa...',
              ...
              {/* Modal Footer */}
              <div className="p-8 bg-white dark:bg-slate-800 border-t border-slate-100 flex items-center justify-between shrink-0">
                  <div className="flex items-center gap-3">
