                    ...
                    <Table>
                        <TableHeader className="bg-muted/30">
                            <TableRow className="hover:bg-transparent border-border/10">
                                <TableHead className="py-6 px-8 text-[12px] font-bold uppercase tracking-widest text-muted-foreground/60 w-[30%]">Nome da Obrigação</TableHead>
                                <TableHead className="text-[12px] font-bold uppercase tracking-widest text-muted-foreground/60">Tipo</TableHead>
                                <TableHead className="text-[12px] font-bold uppercase tracking-widest text-muted-foreground/60">Regimes</TableHead>
                                <TableHead className="text-[12px] font-bold uppercase tracking-widest text-muted-foreground/60">Departamento</TableHead>
                                <TableHead className="text-[12px] font-bold uppercase tracking-widest text-muted-foreground/60 text-center">Dia Venc.</TableHead>
                                <TableHead className="text-[12px] font-bold uppercase tracking-widest text-muted-foreground/60">Alertas</TableHead>
                                <TableHead className="text-right px-8 text-[12px] font-bold uppercase tracking-widest text-muted-foreground/60 w-[120px]">Ações</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {loading ? (
