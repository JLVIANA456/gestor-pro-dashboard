    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700 pb-10">
            ...
            <Dialog open={!!selectedDay} onOpenChange={o => !o && setSelectedDay(null)}>
                <DialogContent className="max-w-[calc(100vw-2rem)] lg:max-w-4xl w-full p-0 overflow-hidden rounded-[2rem] lg:rounded-[2.5rem] border border-border/30 bg-card shadow-2xl max-h-[92vh] flex flex-col">
                    {selectedDay && (
                        <DaySheet
                            day={selectedDay}
...
function DaySheet({ day, entries }: { day: Date; entries: { guide: EnrichedGuide; phase: Phase }[] }) {
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden">
            {/* Header */}
            <div className="p-5 lg:p-6 border-b border-border/10 bg-muted/10 shrink-0">
                <SheetHeader>
            ...
            {/* Footer */}
            <div className="border-t border-border/10 px-5 lg:px-6 py-4 bg-muted/10 flex items-center justify-between shrink-0">
