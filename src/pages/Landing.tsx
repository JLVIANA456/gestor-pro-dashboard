...
export default function Landing() {
    ...
    return (
        <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-primary/10 overflow-x-hidden">
                ...
                <div className="max-w-7xl mx-auto px-8 h-20 flex items-center justify-between">
                    ...
                    <div className="hidden lg:flex items-center gap-10">
                        ...
                        <Button
                            ...
                            className="h-11 px-8 rounded-full bg-primary text-white hover:bg-primary/90 shadow-lg shadow-primary/20 transition-all active:scale-95 text-[10px] font-bold uppercase tracking-widest"
                        >
                            Entrar no Sistema
                        </Button>
                    </div>
            ...
            <section className="pt-40 pb-20 relative px-6 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    ...
                    >
                        ...
                        <h1 className="text-6xl md:text-7xl font-light text-slate-900 tracking-tight leading-[1.1] mb-8">
                            JLVIANA<br />
                            <span className="font-medium text-primary italic">Conecta.</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                            <Button
                                onClick={() => setShowLogin(true)}
                                size="lg"
                                className="h-20 px-14 rounded-full bg-primary text-white text-lg font-bold shadow-2xl shadow-primary/30 hover:bg-primary/90 hover:scale-105 transition-all group"
                            >
                ...
                <div className="max-w-7xl mx-auto space-y-40">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        ...
                        >
                            ...
                            <img
                                src="/auditoria.png"
                                alt="Sistema de Auditoria Digital"
                                className="relative rounded-[3rem] shadow-2xl border border-white/50"
                            />
                        </motion.div>
            ...
            {/* Final CTA */}
            <section className="py-40 relative px-8 overflow-hidden bg-slate-50">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-primary/5" />
                <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(hsl(var(--primary)) 1px, transparent 1px)', backgroundSize: '40px 40px' }} />

                <div className="max-w-4xl mx-auto text-center relative z-10">
                    <h2 className="text-6xl md:text-8xl font-light tracking-tighter leading-none mb-12 text-slate-900">
                        Pronto para ser <br /> <span className="font-medium italic text-primary">JLVIANA?</span>
                    </h2>
                    <p className="text-slate-500 text-xl font-light mb-16 max-w-xl mx-auto">
                        Junte-se à revolução da contabilidade digital. Comece agora a gerenciar seu negócio com inteligência.
                    </p>
                    <Button
                        onClick={() => setShowLogin(true)}
                        className="h-24 px-16 rounded-full bg-primary text-white text-2xl font-bold hover:bg-primary/90 hover:scale-105 transition-all shadow-[0_30px_60px_-15px_rgba(220,38,38,0.3)]"
                    >
                        Comece Agora
                    </Button>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-8">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-20">
                        <div className="flex flex-col items-center md:items-start gap-4">
                            <div className="flex items-center gap-3">
                                <div className="h-12 w-12 rounded-xl bg-primary/5 flex items-center justify-center overflow-hidden border border-primary/10">
                                    {logoUrl ? (
                                        <img src={logoUrl} alt="Logo" className="h-full w-full object-contain p-1" />
                                    ) : (
                                        <Building2 className="h-6 w-6 text-primary" />
                                ...
                                <div className="flex flex-col">
                                    <span className="text-2xl font-bold tracking-tight text-slate-900">JLVIANA</span>
                                    <span className="text-[8px] font-bold uppercase tracking-[0.4em] text-primary -mt-1">Consultoria Contábil</span>
                                </div>
                            </div>
                        </div>

                        <div className="flex gap-16 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                            <div className="flex flex-col gap-4">
                                <span className="text-slate-900">Links Rápidos</span>
                    ...
                    <div className="pt-12 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-8 text-[10px] font-bold text-slate-400 uppercase tracking-[0.4em]">
                        <span>© 2026 JLVIANA • EXCELÊNCIA EM INTELIGÊNCIA CONTÁBIL</span>
                        <div className="flex gap-10">
                            <span className="flex items-center gap-2 tracking-[0.2em]"><Globe className="h-3 w-3" /> BRASIL</span>
                            <span className="flex items-center gap-2 tracking-[0.2em]"><ShieldCheck className="h-3 w-3" /> CONEXÃO SEGURA</span>
                        </div>
                    </div>
                </div>
            </footer>
