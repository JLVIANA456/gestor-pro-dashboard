...
export default function DPDemands() {
    ...
    const handleExportXLSX = () => {
        const dataToExport = filteredTasks.map(t => ({
            ...
            'Data Base': t.dataBase ? format(parseISO(t.dataBase), 'dd/MM/yyyy') : '',
            'Prazo Fatal': t.prazo ? format(parseISO(t.prazo), 'dd/MM/yyyy') : '',
    ...
    const getSlaBadge = (status?: SLAStatus) => {
        switch (status) {
            ...
            case 'FUTURO': return <Badge variant="secondary" className="bg-blue-500/10 text-blue-700 border-blue-500/20 text-[9px] uppercase tracking-widest font-black h-5">No Prazo</Badge>;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div className="relative group overflow-hidden rounded-[2rem] border border-red-200/50 bg-gradient-to-b from-red-50/50 to-transparent dark:from-red-950/20 dark:border-red-900/50 p-6 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-1 isolation-auto">
                    ...
                    <div className="mt-4 flex items-center gap-2">
                        ...
                        <span className="text-[10px] text-red-600 font-black uppercase tracking-widest">Pendências Fatais</span>
                    </div>
                </div>
            </div>
                    ...
                    <Table>
                        <TableHeader className="bg-muted/30">
                            <TableRow className="border-border/10 hover:bg-transparent">
                                ...
                                <TableHead className="py-5 text-[10px] uppercase tracking-[0.2em] font-normal">Data Base</TableHead>
                                <TableHead className="py-5 text-[10px] uppercase tracking-[0.2em] font-normal">Prazo Fatal</TableHead>
                                    ...
                                    <TableRow key={task.id} className="group border-border/5 hover:bg-muted/10 transition-colors">
                                        ...
                                        <TableCell>
                                            <div className="flex flex-col -gap-1">
                                                ...
                                                {task.atrasoDias && task.atrasoDias > 0 && task.status === 'PENDENTE' && (
